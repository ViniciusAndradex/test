...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("IP/ID Whitelisting", "Lista de IPs/IDs Confiáveis"),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Utilize com responsabilidade!"),
        ...
        ("Use IP/ID Whitelisting", "Utilizar lista de IPs/IDs confiáveis"),
        ("Network", "Rede"),
        ("Pin Toolbar", "Fixar barra de ferramentas"),
        ("Unpin Toolbar", "Desfixar barra de ferramentas"),
        ("Recording", "Gravando"),
        ("Directory", "Diretório"),
        ...
        ("Stop", "Parar"),
        ("exceed_max_devices", ""),
        ("Sync with recent sessions", "Sincronize com sessões recentes"),
        ("Sort tags", "Classificar tags"),
        ("Open connection in new tab", "Abrir conexão em nova janela"),
        ("Move tab to new window", "Mover guia para nova janela"),
        ...
        ("Reverse mouse wheel", "Inverter rotação da roda do mouse"),
        ("{} sessions", "{} sessão"),
        ("scam_title", ""),
        ("scam_text1", ""),
        ("scam_text2", ""),
        ...
        ("Connection failed due to inactivity", "Falha na conexão devido à inatividade"),
        ("Check for software update on startup", "Verifique se há atualização de software na inicialização"),
        ("upgrade_rustdesk_server_pro_to_{}_tip", ""),
        ("pull_group_failed_tip", ""),
        ("Filter by intersection", "Filtrar por intersecção"),
        ("Remove wallpaper during incoming sessions", "Remova o papel de parede durante as sessões recebidas"),
        ("Test", "Teste"),
        ("switch_display_elevated_connections_tip", ""),
        ("display_is_plugged_out_msg", ""),
        ("No displays", "Sem exibição"),
        ("elevated_switch_display_msg", ""),
        ("Open in new window", "Abrir em nova janela"),
        ("Show displays as individual windows", "Mostrar exibições como janelas individuais"),
        ("Use all my displays for the remote session", "Usar todos os meus monitores para a sessão remota"),
        ("selinux_tip", ""),
        ("Change view", "Alterar visualização"),
        ("Big tiles", "Grandes títulos"),
        ("Small tiles", "Pequenos títulos"),
        ("List", "Lista"),
        ("Virtual display", "Tela virtual"),
        ("Plug out all", "Desligar tudo"),
        ("True color (4:4:4)", "Cor verdadeira (4:4:4)"),
        ("Enable blocking user input", "Habilitar bloqueio de entrada do usuário"),
        ("id_input_tip", ""),
        ("privacy_mode_impl_mag_tip", ""),
        ("privacy_mode_impl_virtual_display_tip", ""),
        ("Enter privacy mode", "Entre no modo de privacidade"),
